...
10. [Какой класс является базовым родительским классом для всех классов?](#Какой-класс-является-базовым-родительским-классом-для-всех-классов)
...
следования. То есть могут быть два конструктора с параметрами идентичных типов, но эти параметры должны размещаться в разном порядке.
